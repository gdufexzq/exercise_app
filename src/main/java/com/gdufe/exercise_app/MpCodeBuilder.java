package com.gdufe.exercise_app;
...
public class MpCodeBuilder {
    ...
    public void generateCode() {
        //指定包名
        String packageName = "com.gdufe.exercise_app";
        //user -> UserCopyService, 设置成true: user -> IUserService
        boolean serviceNameStartWithI = false;
        //指定生成的表名
        String[] tableNames = new String[]{"exercise_total"};
    ...
    private GlobalConfig getGlobalConfig(boolean serviceNameStartWithI) {
        ...
        globalConfig
                ...
                .setAuthor("xuzhiquan")
                //设置输出路径
                .setOutputDir(getOutputDir("exercise_app"))
    ...
    private DataSourceConfig getDataSourceConfig() {
        String dbUrl = "jdbc:mysql://localhost:3306/exercise_app?serverTimezone=GMT%2B8";
